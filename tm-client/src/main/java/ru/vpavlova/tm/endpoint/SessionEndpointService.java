...
public class SessionEndpointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tm.vpavlova.ru/", "SessionEndpointService");
    public final static QName SessionEndpointPort = new QName("http://endpoint.tm.vpavlova.ru/", "SessionEndpointPort");
    static {
        URL url = null;
        try {
