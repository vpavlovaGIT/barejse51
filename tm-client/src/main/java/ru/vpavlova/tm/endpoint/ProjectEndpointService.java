...
public class ProjectEndpointService extends Service {
    ...
    public final static QName SERVICE = new QName("http://endpoint.tm.vpavlova.ru/", "ProjectEndpointService");
    public final static QName ProjectEndpointPort = new QName("http://endpoint.tm.vpavlova.ru/", "ProjectEndpointPort");
    static {
        URL url = null;
        try {
