...
public final class TaskDTOService extends AbstractDTOService<TaskDTO> implements ITaskDTOService {
    ...
    @Override
    @SneakyThrows
    public Optional<TaskDTO> findOneById(
    ...
    @Override
    @SneakyThrows
    public Optional<TaskDTO> findOneByIndex(
    ...
    @Override
    @SneakyThrows
    public Optional<TaskDTO> findOneByName(
    ...
    public void removeOneByIndex(
        ...
        try {
            entityManager.getTransaction().begin();
            @NotNull final ITaskDTORepository taskRepository = new TaskDTORepository(entityManager);
            @NotNull Optional<TaskDTO> task = taskRepository.findOneByIndex(userId, index);
    ...
    @Override
    @SneakyThrows
    public @NotNull List<TaskDTO> findAll(@Nullable String userId, @Nullable String sort) {
        if (userId.isEmpty()) throw new EmptyUserIdException();
        @NotNull final EntityManager entityManager = connectionService.getEntityManager();
        @NotNull final ITaskDTORepository taskRepository = new TaskDTORepository(entityManager);
    ...
    public void changeStatusById(
        ...
        @NotNull final Optional<TaskDTO> entity = findOneById(userId, id);
    ...
    public void changeStatusByIndex(
        ...
        if (index < 0) throw new IndexIncorrectException();
        if (status == null) throw new ObjectNotFoundException();
        @NotNull final Optional<TaskDTO> entity = findOneByIndex(userId, index);
        if (!entity.isPresent()) throw new ObjectNotFoundException();
        entity.get().setStatus(status);
        @NotNull final EntityManager entityManager = connectionService.getEntityManager();
        try {
    ...
    public void changeStatusByName(
        ...
        if (name.isEmpty()) throw new EmptyNameException();
        if (status == null) throw new ObjectNotFoundException();
        @NotNull final Optional<TaskDTO> entity = findOneByName(userId, name);
        if (!entity.isPresent()) throw new ObjectNotFoundException();
        entity.get().setStatus(status);
        @NotNull final EntityManager entityManager = connectionService.getEntityManager();
        try {
